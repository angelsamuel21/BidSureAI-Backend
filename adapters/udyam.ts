...
export class UdyamAdapter implements GovernmentVerificationAdapter {
  portalName = 'UDYAM' as const

  async verify(udyamNumber: string, context?: { expectedLegalName?: string }): Promise<PortalVerificationRecord> {
