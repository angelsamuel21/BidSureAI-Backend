...
class PathCache {
    ...
    getAAP({ basePath, aliasPath }) {
        ...
        while (!(pathExists = this.exists((0, path_1.join)(basePath, aliasPathPart))) && aliasPathParts.length) {
