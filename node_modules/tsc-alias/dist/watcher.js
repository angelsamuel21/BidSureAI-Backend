...
function setupFileWatcher(params) {
    ...
    const onFileChange = async (file) => await (0, helpers_1.replaceAlias)(config, file, options === null || options === void 0 ? void 0 : options.resolveFullPaths);
