...
function testAuditChain() {
  ...
  function calculateHash(prev: any, action: any, time: any, actor: any, details: any) {
    return crypto.createHash('sha256').update(`${prev}|${action}|${time}|${actor}|${details}`).digest('hex')
  }
